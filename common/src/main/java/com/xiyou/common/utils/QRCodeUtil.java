...
public class QRCodeUtil {
    ...
    public static void generateQRCode(String content, HttpServletResponse response) throws Exception {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(content), "二位码内容为空");
        generateQRCode(content, response, height, width);
    }

    public static void generateQRCode(String content, HttpServletResponse response, int height, int width) throws Exception {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(content), "二位码内容为空");
